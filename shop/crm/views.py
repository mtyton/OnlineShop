...
from crm.forms import (BaseProductInfoForm, ProductAvailabilityForm,
                       ProductImageForm, AvailabilityUpdateForm, AddImageForm)
from products.models import Category, Size, ProductAvailability, Product
from crm.utils import FormDataExtractor
...
add_product_view = staff_member_required(AddProductView.as_view())


class AvailabilityUpdateView(View):
...
update_availability_view = staff_member_required(
    AvailabilityUpdateView.as_view())


class UploadImageForm(View):
...
image_upload_view = staff_member_required(UploadImageForm.as_view())
