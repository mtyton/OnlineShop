...
#         parser.add_argument(
#             "--apps", nargs="+", help="List of applications names for which " "fixtures will be generated"
#         )
#
#     def __discover_generators(self, apps: List[str]) -> List[str]:
#         # TODO add applications_names
#         # TODO - change this to importlib
#         # exec(f"from {settings.FIXTURE_GENERATOR_PATH} " f"import {settings.FIXTURE_GENERATOR_DISCOVERER}")
...
#         # TODO - do not use exec here
#         # exec(f"from {generator_path} " f"import {settings.FIXTURE_GENERATOR_CLASS_NAME} " f"as {generator_name}")
